...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            setIsLoading(false)
            if (email === 'sophie.martin@univ.fr' && password === 'student' && role === 'etudiant') {
                // Marquer l'utilisateur comme connecté pour le ProtectedRoute
                localStorage.setItem('isLoggedIn', 'true')
                navigate('/Etudiant')
            }
            else if (email === 'admin@univ.fr' && password === 'admin' && role === 'admin') {
                // Marquer l'utilisateur comme connecté pour le ProtectedRoute
                localStorage.setItem('isLoggedIn', 'true')
                navigate('/Admin')
            }
            else if (email === 'jean.dupont@univ.fr' && password === 'technician' && role === 'technicien') {
                // Marquer l'utilisateur comme connecté pour le ProtectedRoute
                localStorage.setItem('isLoggedIn', 'true')
                navigate('/Technicien')
            }
